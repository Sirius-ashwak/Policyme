    ...
    return (
        <div className="animate-fade-in">
            <header className="mb-12">
                <h1 className="text-4xl font-extrabold tracking-tight font-[Manrope] mb-2">Claims History</h1>
                <p className="text-[var(--insurai-on-surface-variant)] text-lg max-w-2xl leading-relaxed">
                    A complete record of all your filed insurance claims and their outcomes.
                </p>
            </header>

            <div className="space-y-4">
                {[
                    { id: "CL-90122", title: "Windshield Damage", status: "In Review", statusColor: "bg-blue-100 text-blue-700", date: "Oct 14, 2023", amount: "$1,250.00" },
                    { id: "CL-88401", title: "Rear-end Collision", status: "Approved", statusColor: "bg-green-100 text-green-700", date: "Aug 3, 2023", amount: "$4,250.00" },
                    { id: "CL-77219", title: "Hail Damage — Roof", status: "Closed", statusColor: "bg-slate-100 text-slate-600", date: "Mar 18, 2023", amount: "$8,900.00" },
                ].map((claim) => (
